...
The goal of `linktree` is to estimate the *group transmission assortativity coefficient*. More information [here](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0313037).
